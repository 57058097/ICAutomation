...
public class GenerateReport
{
    ...
    public static ExtentReports extent = new ExtentReports("./TestReports/" + "IC_TestReport_" + new SimpleDateFormat("MMddHHmm").format(new Date())+ ".html" , true);
    ...
    public static void logTestStepResult(String teststepresult, String teststepID, String teststepdescription, String testcaseID, String testcasename, String exception) {
    	...
    	if (teststepresult == "PASS") {    		
    		...
    		String imagepath = "../Screenshots/IC/" + DriverScript.screenShotFolderName + "/" + testcaseID + "_" + teststepID + ".png";
